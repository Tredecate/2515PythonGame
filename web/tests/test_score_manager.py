...
def test_manager_remove_scores_user(manager, good):
    """D0006 Correct score is removed"""
    for _ in range(0, 5):
        manager.add_score(good)
